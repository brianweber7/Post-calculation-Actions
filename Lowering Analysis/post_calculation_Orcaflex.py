...
def Execute(info):
	# Set line variables in the model
	...
	# SpreaderBar = info.model['Spreader Bar']
	...
	LowerSling_2_Tension_SB * np.sin(np.radians(180 - LowerSling_2_angle)) + \
	LowerSling_3_Tension_SB * np.sin(np.radians(180 - LowerSling_3_angle)) + \
	LowerSling_4_Tension_SB * np.sin(np.radians(180 - LowerSling_4_angle))
